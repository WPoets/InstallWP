...
switch($step) {
	case 0:	
?>
<form method="post" action="<?php echo $current_filename; ?>.php?step=1">
	...
	<table class="form-table">
		...
		<tr>
			<th scope="row"><label for="admin_email">Admin User Email</label></th>
			<td><input name="admin_email" id="admin_email" type="text" size="45" value=""/></td>
			<td>Email of the default admin user</td>
		</tr>
	</table>
	<input name="prefix" id="prefix" type="hidden" id="prefix" value="wp_" size="25" />
		...
		echo '<li>writting wp-config file</li>';
			...
			foreach ($configFile as $line_num => $line) {
				switch (substr($line,0,16)) {
					case "define('DB_NAME'":
						fwrite($handle, str_replace("database_name_here", $dbname, $line));
						break;
					case "define('DB_USER'":
						fwrite($handle, str_replace("'username_here'", "'$uname'", $line));
						break;
					case "define('DB_PASSW":
						fwrite($handle, str_replace("'password_here'", "'$passwrd'", $line));
						break;
					case "define('DB_HOST'":
					...
					default:
						...
						{
							fwrite($handle, $salts[1]."\n");
						}
						else if($line_num=='46')
						{	
							fwrite($handle, $salts[2]."\n");
						}
						else if($line_num=='47')
						{
							fwrite($handle, $salts[3]."\n");
						}
						else if($line_num=='48')
						{
							fwrite($handle, $salts[4]."\n");
						}
						else if($line_num=='49')
						{
							fwrite($handle, $salts[5]."\n");
						}
						else if($line_num=='50')
						{
							fwrite($handle, $salts[6]."\n");
						}
						else if($line_num=='51')
						{
							fwrite($handle, $salts[3]."\n");
